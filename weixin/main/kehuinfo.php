...
<link type="text/css"  rel="stylesheet" href="http://www.zduber.com/yunku/css/signupstyle.css" />
            <style>
            	.head{
					/*text-align:center;*/
					height:100px;
				...
				body{
					background:url(http://www.zduber.com/yunku/images/bg_kehu.jpg);
...
<body onLoad="echoto('<?php echo $_GET["key"]; ?>')">
	<div class="main" style="">
               ...
               <div style="text-align:center; margin:15px 41.5% 15px 41.5%; "  > <div class="head"><img src="<?php echo $_GET["head"];?>" width="100px" height="100px" ;></div></div>
				 ...
				 <form>
                    ...
                    <input type="text" class="input-khinfo" onFocus="cls()" placeholder="您的手机号码"  onBlur="checkphone(this);ckuser()" id="tel" value="<?php echo $_GET["tel"];?>">
