        ...
        <div id="u3_state0" class="panel_state" data-label="State1">
          <div id="u3_state0_content" class="panel_state_content">
            ...
            <div id="u6" class="ax_default box_1">
              ...
              <!-- Unnamed () -->
              <div id="u7" class="text" style="visibility: visible;" onclick="login()">
                <p><span>登入</span></p>
              </div>
            </div>
            ...
            <div id="u14" class="ax_default text_field" data-label="0">
              <input id="user"  onfocus="cls()" onblur="check(this)" placeholder="输入您的用户名"  type="text" value=""/>
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u15" class="ax_default text_field">
              <input  name="pwd" id="pwd" onfocus="cls()"  onkeypress='enter()' placeholder="请输入您的密码" type="password" />
            </div>
