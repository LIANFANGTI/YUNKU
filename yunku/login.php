...
<html>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- 背景 (动态面板) -->
      <div id="u0" class="ax_default ax_default_hidden" data-label="背景" style="display: none; visibility: hidden">
        <div id="u0_state0" class="panel_state" data-label="State1">
          <div id="u0_state0_content" class="panel_state_content">

            <!-- Unnamed (图片) -->
            <div id="u1" class="ax_default image">
              <img id="u1_img" class="img " src="images/index/319910-106.jpg"/>
              <!-- Unnamed () -->
      ...
      <!-- 1 (动态面板) -->
      <div id="u3" class="ax_default ax_default_hidden" data-label="1" style="display: none; visibility: hidden">
        <div id="u3_state0" class="panel_state" data-label="State1">
          <div id="u3_state0_content" class="panel_state_content">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u6" class="ax_default box_1" onclick='login(1)'>
            ...
            <!-- t1 (矩形) -->
            <div id="u10" class="ax_default box_1" data-label="t1">
            ...
            <!-- t2 (矩形) -->
            <div id="u12" class="ax_default box_1" data-label="t2">
            ...
            <!-- 0 (文本框) -->
            <div id="u14" class="ax_default text_field" data-label="0">
              <input id="u14_input" onchange='setUser(this)' type="text" value=""/>
            </div>
			
            <!-- Unnamed (文本框) -->
            <div id="u15" class="ax_default text_field">
              <input id="u15_input" onkeypress='setPwd(this)' onkeyup='setPwd(this)' type="password" value=""/>
            </div>
			<script>
			    User=Pwd="";
				function setUser(e){
					User=e.value;
					if(!EXIST("user","user",e.value)){
						errorMsg.innerHTML="用户名不存在"
					}else{
						errorMsg.innerHTML=""
						login(0)
				...
				function login(m){
					printr(User+"|"+Pwd);
					if(User!=""&&Pwd!=""){
						if(EXIST("user","user",User)){
							if(Pwd==SELECT_B("user","password","user="+User)){
								Ajax2({atype:"login",user:User,pwd:Pwd})
								errorMsg.innerHTML="登录成功";
								location.replace("../zdcar2/");
							}else{
								if(m)errorMsg.innerHTML="密码错误";
							}
						}
					}else{
						errorMsg.innerHTML="请填写正确信息";	
					}
            ...
            <div id="u18" class="ax_default label">
              ...
              <div id="u19" class="text" style="visibility: visible;">
                <p><span id="errorMsg" style="color:#e45151;"></span></p>
              </div>
            </div>

            <!-- 22 (矩形) -->
            <div id="u20" class="ax_default label" data-label="22">
            ...
            <!-- Unnamed (复选框) -->
            <div id="u22" class="ax_default checkbox">
              <label for="u22_input">
                <!-- Unnamed () -->
