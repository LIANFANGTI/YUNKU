...
<html>
	...
	<body>
		...
		<table class="table table-striped table-bordered table-hover text-center">
			<tr><td colspan="6"><h1><?php echo $cpname."消费记录管理系统"; ?></h1></td></tr>   
			<tr >
				<td>序号</td>
				<td>用户名</td>
				<td>密码</td> 
			...
			<?php 
				$i=1;
				$db->select("user","*","del and company=".$cp."");$USERS=$db->fetchArray(MYSQL_ASSOC);
			...
			<tr>
				<td colspan="6"><input type="button" class="btn btn-info" value="添加" onclick="AddUser(this)" id="AddUserButton"/></td>
