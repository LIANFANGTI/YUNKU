<?php  
    class Page3{  
      ...
      //构造方法初始化  
      public function __construct($_total, $_pagesize,$NowPage,$id,$fun) {  
	  ...
	  $_pagelist ="";
         for ($i=$this->bothnum;$i>=1;$i--) {  
            $_page = $this->page-$i;  
            if ($_page < 1) continue;  
                $_pagelist .= ' <a class="btn btn-info btn-xs" href="javascript:'.$this->fun.'(\''.$this->id.'\','.$_page.')">'.$_page.'</a> ';  
         }  
      ...
      private function last() {  
		 ...
		 $urla="javascript:".$this->fun."('".$this->id."',".($this->page-1).")";
